		...
		<form onsubmit="submit_form(event)" method="post" enctype="multipart/form-data">
			...
			<div class="row g-3 col-md-6 mx-auto shadow p-4 rounded">
				...
				<div class="mb-3 col-md-6">
					...
					<input name="first_name" value="<?= old_value('first_name',$row->first_name) ?>" type="text" class="form-control" id="first_name" placeholder="nombre">
				...
				<div class="mb-3 col-md-6">
					...
					<input name="last_name" value="<?= old_value('last_name',$row->last_name) ?>" type="text" class="form-control" id="last_name" placeholder="apellido">
